...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed">
    <div class="wrapper">
        ...
        <!-- Navbar -->
        @include('doctor.layouts.partials._navbar')
        <!-- /.navbar -->

        <!-- Main Sidebar Container -->
        @include('doctor.layouts.partials._sidebar')
        ...
        <!-- Control Sidebar -->
        @include('doctor.layouts.partials._control-sidebar')
        <!-- /.control-sidebar -->

        <!-- Main Footer -->
        @include('doctor.layouts.partials._footer')
    </div>
    <!-- ./wrapper -->
